      ...
      <div className="courses__rating-wrap">
         ...
         <div className="course-review-head">
            ...
            <div className="review-author-content">
               ...
               <h4 className="title">สุดยอดระบบออกแบบ LMS</h4>
               <p>Maximus ligula eleifend id nisl ซึ่งบางครั้ง แต่ malesuada tortor ไม่ได้น่าเกลียดเสมอไป ดื่มเหล้าเว้นแต่ประตู เสียงหัวเราะ malesuada ไม่ได้ช่วยอะไรกับความเจ็บปวด สิ่งแรกในตอนเช้าก็คือสิ่งแรกในตอนเช้า</p>
            </div>
         </div>
      </div>
   )
