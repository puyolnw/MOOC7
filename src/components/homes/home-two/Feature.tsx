            ...
            <div className="row justify-content-center">
               <div className="col-xl-6 col-lg-8">
                  <div className="section__title text-center mb-40">
                     ...
                     <h2 className="title">บรรลุเป้าหมายของคุณด้วย SkillGrow</h2>
                     <p>เมื่อช่างพิมพ์ที่ไม่รู้จักคนหนึ่งหยิบแท่นพิมพ์ขึ้นมาแล้วพิมพ์สลับกัน <br /> หนังสือตัวอย่างได้ผ่านมาไม่เพียงแค่ห้าศตวรรษเท่านั้น</p>
                  </div>
               </div>
            </div>
