...
import AddQuizzes from "../../../../forms/Course/AddQuizzes";
...
const AddQuizzesArea: React.FC<AddQuizzesAreaProps> = ({ isEmbedded = false, onSubmit }) => {
  ...
  const handleSubmit = (quizData: any) => {
    ...
    // *** ส่วนที่ถูกลบออก: alert("บันทึกข้อมูลสำเร็จ"); ***
    // หากต้องการการแจ้งเตือนในหน้าเต็ม สามารถเพิ่มระบบ Notification ที่เหมาะสมได้ที่นี่
    // หรือให้คอมโพเนนต์แม่ที่เรียกใช้ AddQuizzesArea เป็นผู้จัดการแจ้งเตือน
  };
