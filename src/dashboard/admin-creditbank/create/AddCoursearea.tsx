...
const AddCoursearea: React.FC = () => {
  ...
  const [availableSubjects] = useState<Subject[]>([
    { id: "sub1", title: "คณิตศาสตร์พื้นฐาน", instructor: "ดร.คณิต ศาสตร์", description: "พื้นฐานคณิตศาสตร์สำหรับนักศึกษา", coverImage: "/assets/img/courses/course_thumb01.jpg" },
    { id: "sub2", title: "เคมี 1", instructor: "รศ.ดร.เคมี วิทยา", description: "พื้นฐานเคมีทั่วไป", coverImage: "/assets/img/courses/course_thumb02.jpg" },
    { id: "sub3", title: "เคมี 2", instructor: "รศ.ดร.เคมี วิทยา", description: "เคมีขั้นกลาง", coverImage: "/assets/img/courses/course_thumb03.jpg" },
    { id: "sub4", title: "เคมี 3", instructor: "รศ.ดร.เคมี วิทยา", description: "เคมีขั้นสูง", coverImage: "/assets/img/courses/course_thumb04.jpg" },
    { id: "sub5", title: "ฟิสิกส์พื้นฐาน", instructor: "ผศ.ดร.ฟิสิกส์ ศาสตร์", description: "พื้นฐานฟิสิกส์สำหรับนักศึกษา", coverImage: "/assets/img/courses/course_thumb05.jpg" },
    { id: "sub6", title: "ชีววิทยาทั่วไป", instructor: "ศ.ดร.ชีวะ วิทยา", description: "พื้นฐานชีววิทยา", coverImage: "/assets/img/courses/course_thumb06.jpg" },
    { id: "sub7", title: "สถิติเบื้องต้น", instructor: "อ.สถิติ ศาสตร์", description: "พื้นฐานสถิติและการวิเคราะห์ข้อมูล", coverImage: "/assets/img/courses/course_thumb07.jpg" },
    { id: "sub8", title: "การเขียนโปรแกรมเบื้องต้น", instructor: "อ.โปรแกรม เมอร์", description: "พื้นฐานการเขียนโปรแกรม", coverImage: "/assets/img/courses/course_thumb08.jpg" },
  ]);
  ...
  const handleAddSubject = (subjectId: string) => {
    if (courseData.subjects.includes(subjectId)) {
      alert("รายวิชานี้ถูกเพิ่มในหลักสูตรแล้ว");
      return;
    }
  ...
  const handleAddPrerequisite = (prerequisiteId: string) => {
    ...
    if (exists) {
      alert("ความสัมพันธ์นี้มีอยู่แล้ว");
      return;
    }
    
    // Check if this would create a circular dependency
    if (selectedSubjectForPrereq === prerequisiteId) {
      alert("รายวิชาไม่สามารถเป็นวิชาก่อนหน้าของตัวเองได้");
      return;
    }
  ...
  // Debug state changes
  useEffect(() => {
    console.log("Subjects updated:", courseData.subjects);
  }, [courseData.subjects]);
                          ...
                          <div className="ratio ratio-16x9">
                            <iframe
                                                ...
                                                <div className="d-flex justify-content-end gap-2 mt-4">
                                                  <Link to="/admin-creditbank" className="btn btn-outline-secondary">
                                                    ยกเลิก
                                                  </Link>
