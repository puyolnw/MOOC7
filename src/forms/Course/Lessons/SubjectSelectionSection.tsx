...
interface SubjectSelectionSectionProps {
  lessonData: {
    subjects: string[]; // หรือ number[] ขึ้นอยู่กับประเภทของ subjectId
  };
  ...
  setSubjectSearchTerm: (term: string) => void;
  filteredSubjects: { id: string; title: string; subject_code?: string; category?: string }[];
